...
# $Header: /u/cgt/cvs/bin/cc/Makefile.be,v 1.1 1998/01/27 06:15:45 parag Exp $
...
FILES = Makefile CCtst.make FEATURES cppdefs.h cpp.h globals.h error.h \
...
LIBS=../float/libfloat.a ../integer/libinteger.a ../aoa/libaoa.a ../cgt/libcgt.a
...
cctst: $(COBJS) $(CPPOBJS) cctst.o 
	$(CC) $(LFLAGS) $(CFLAGS) -o $@ $(CPPOBJS) $(COBJS) cctst.o $(LIBS)
cctst.o: cctst.cc cc.h ccsym.h cctype.h cpp.h ccsetup.h

cc-fcode: $(COBJS) $(FCODE) $(CPPOBJS)
	$(CC) $(LFLAGS) $(CFLAGS) -o $@ $(CPPOBJS) $(COBJS) $(FCODE) $(LIBS)
...
cc-m68k: $(COBJS) $(CTREE) $(CPPOBJS) $(M68K)
	$(CC) $(LFLAGS) $(CFLAGS) -o $@ $(CPPOBJS) $(COBJS) $(CTREE) $(M68K) $(TLIBS)

cc-hc11: $(COBJS) $(CTREE) $(CPPOBJS) $(HC11)
	$(CC) $(LFLAGS) $(CFLAGS) -o $@ $(CPPOBJS) $(COBJS) $(CTREE) $(HC11) $(TLIBS)
...
cpptst: cppmain.o $(CPPOBJS)
	$(CC) $(LFLAGS) $(CFLAGS) -o $@ cppmain.o $(CPPOBJS) $(LIBS)
...
testcpp: cpptst
	./cpptst testcpp.h >testcpp.out 2>&1
	diff testcpp.good testcpp.out
